...
do_compile() {
    ...
    oe_runmake CC="${CC}" CXX="${CXX}" HOSTCC="${HOSTCC}" CFLAGS="${CFLAGS} -I${STAGING_INCDIR}/libelf -I${STAGING_INCDIR} -I${STAGING_DIR_TARGET}${includedir} -I${STAGING_DIR_TARGET}${includedir}/libelf -I${S}/gnu-efi/inc/ -I${S}/gnu-efi/inc/x86_64/" LDFLAGS="${LDFLAGS} -L${STAGING_LIBDIR} -L${libdir}"
}
