...
# libgtk-3-0
# glib
RDEPENDS:${PN} = "  xwayland libvpx aom yuv libopus alsa-lib gtk+3 libx11 openssl pulseaudio zlib libgit2 libsodium "

# libvpx-staticdev
# aom-staticdev
# yuv-staticdev
# libopus-staticdev
DEPENDS += " alsa-lib gtk+3 libx11 openssl pulseaudio zlib bindgen-cli-native clang-native pkgconfig-native yasm zip libgit2 libsodium "
